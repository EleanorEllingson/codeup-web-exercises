(function() {
    ...
    shoppers.forEach(function (shopper) {
        ...
        if(shopper.amount >= 200){
            newPrice = shopper.amount - shopper.amount * discount;
        }
        else if(shopper.amount < 200){
            newPrice = shopper.amount;
        }

        console.log("Name: " + shopper.name + ":" + " Price to pay before discount: " + shopper.amount + " Price to pay after discount: " + newPrice);
    ...
    var books = [
        {
            ...
            author: {firstName: "Robert ", lastName: "Jordan"},
        },
        {
            title: "The Way of Kings",
            author: {firstName: "Brandon ", lastName: "Sanderson"},
        },
        {
            title: "Harry Potter",
