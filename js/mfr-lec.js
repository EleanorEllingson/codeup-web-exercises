...
// let newArray2 = numbers.map(function (num){
//     return num * 3;
// });

let newArray2 = numbers.map(num => num * 3);
...
const fruit = fruitsAndVeggies.filter(produce => produce.type === 'fruit');

console.log(fruit);


// TODO: filter through the array of objects and return all vegetable type objects.
// const vegatables = fruitsAndVeggies.filter(function (produce){
//     return produce.type === 'vegatable';
// })

const vegatables = fruitsAndVeggies.filter(produce => produce.type === 'vegatable')
...
// to transform a set into an Array: Array.from(insertyourSethere) Using the Set object developer.mozilla.org
